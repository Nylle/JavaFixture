...
[![Maven Central](https://img.shields.io/maven-central/v/com.github.nylle/javafixture.svg?label=maven-central)](http://search.maven.org/#artifactdetails|com.github.nylle|javafixture|1.3.0|)
...
```java
var fixture = JavaFixture.fixture()
```
...
## Generics
Due to Java's type erasure ([read more on baeldung](https://www.baeldung.com/java-type-erasure)), it is difficult to reflect generic classes on runtime. Using JavaFixture however it can be achieved through a little trick:
